...
const getEvents = async () => {
  ...
  const eventList = [
    ...
    },
    {
      ...
      rules:
        "#Whoever does more pushups wins.\n#Players cant stop or rest in between once the game is started.\n#Players will be disqualified if their posture changes in between.",
      whatsappLink: "",
      categories: "Sports",
      isRegOpen: true,
    },
    ...
    },
    {
      ...
      rules:
        "The usage of jailbreak devices in tournament matches is not permitted.\n#teams should have a representative otherwise will be disqualified",
      whatsappLink: "",
    ...
    },
    {
      ...
      rules:
        "Teams that do not return to the starting point within the allotted time will be eliminated from the game.\n# Teams that fail to complete a specified number of tasks within the time limit may be eliminated",
      whatsappLink: "",
    ...
    },
    {
      ...
      rules:
        "#All entries must be original creations. Plagiarism or unauthorized use of copyrighted material is strictly prohibited.·\n# Participants are required to upload their reels to their YouTube channels.",
      whatsappLink: "",
    ...
    },
    {
      ...
      rules:
        "Participants are expected to follow safety precautions when handling tools or potentially hazardous waste materials.\n#After the event, participants are encouraged to responsibly dispose of or recycle their projects to minimize waste",
      whatsappLink: "",
      categories: "Non-Technical, Creative",
      isRegOpen: true,
    },
    ...
    },
    {
      ...
      rules:
        "#Use of editing tools for correcting the mistakes in typed matter is strictly prohibited.\n# Any auto type tool should not be used.\n#Participation certificates for all the participants.",
      whatsappLink: "",
    ...
    },
    {
      ...
      rules:
        " Any violation of the rules of the given at the start day may result in the invalidation of a transaction. Repeated violation of the rules may result in the disqualification of a team.",
      whatsappLink: "",
