  ...
  return (
    <div className="h-full min-h-screen py-[80px] bg-[#2a303c]">
      ...
      <div className="sm:hidden block px-8 py-8">
        <label className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-400">Event Categories</label>
      ...
      <div className="h-full flex gap-8 items-start ">
        ...
        <div id="events">
          <div className="px-8 pb-4  md:w-[420px]">
            <form onSubmit={(e) => { e.preventDefault(); setSearchQuery(e.target.search.value); }}>
              <div className="relative">
                ...
                <input type="search" id="search" className="block p-3 pl-10 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white" placeholder="Search" />
                <button type="submit" className="text-white absolute right-2.5 bottom-2.5 bg-purple-600 hover:bg-purple-800 font-medium rounded-lg text-sm px-3 py-1 ">Search</button>
              </div>
            </form>
          </div>
            ...
            {events
              .filter((event) => {
                if (searchQuery == "") {
                  ...
                  return event['name'].toLowerCase().includes(searchQuery.toLowerCase()) || event['shortDesc'].toLowerCase().includes(searchQuery.toLowerCase());
                }
